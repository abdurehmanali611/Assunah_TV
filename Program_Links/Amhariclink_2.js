...
const Amhariclink_2 = ({navigation}) => {
    ...
    return <ScrollView>
        <Text style = {{marginVertical: 20,fontSize: 20,textAlign: 'center'}}>Second Page of Amharic schedules</Text>
        <View>
            <Text style = {{marginVertical: 20,textAlign: 'center',fontSize: 22}}>Timely Education</Text>
