...
const ArabicPrograms = () => {
    ...
    return(
        <View style = {{backgroundColor: randomRGB(),flex: 1,justifyContent: 'flex-start'}}>
            ...
            <ScrollView>
                <Link 
                style = {{backgroundColor: randomRGB(),marginHorizontal: 20,textDecorationLine: 'underline', width: 300, marginVertical: 10, height: 70, textAlignVertical: 'center', textAlign: ''}}
                to={'/Arabiclink'}>
                <Text style = {{fontSize: 20}}>Education or Ders</Text>
                </Link>
                <Link 
                style = {{backgroundColor: randomRGB(),marginHorizontal: 20,textDecorationLine: 'underline', width: 300, marginVertical: 10, height: 70, textAlignVertical: 'center', textAlign: 'center'}}
                to={'/Arabiclink'}>
