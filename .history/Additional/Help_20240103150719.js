...
const SupportPage = () => {
  ...
  const faqs = [
    { question: 'How do I reset my password?', answer: 'To reset your password, go to the settings...' },
    // More FAQ items...
  ];

  const troubleshootingGuides = [
    { title: 'Playback Issues', content: 'If you are experiencing playback issues...' },
