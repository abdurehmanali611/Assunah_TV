...
const Amhariclink_4 = ({navigation}) => {
    ...
    return <ScrollView>
        <View>
            <Text style = {styles.he}>Amharic program schedule 4</Text>
        <View>
            <Text style = {{marginVertical: 20, textAlign: 'center', fontSize: 20}}>Talk shows</Text>
        ...
        <View>
            <Text style = {{marginVertical: 20, textAlign: 'center', fontSize: 20}}>Entertainment</Text>
        ...
        <View>
            <Text style = {{marginVertical: 20, textAlign: 'center', fontSize: 20}}>Women's Program</Text>
            <View style = {{alignItems: 'center'}}>
                <TouchableOpacity
                style = {styles.talktouch}
        ...
        <View>
            <Text style = {{marginVertical: 20, textAlign: 'center', fontSize: 20}}>Story</Text>
            <View style = {{display: 'flex', flexDirection: 'row'}}>
                <TouchableOpacity
                style = {styles.talktouch}
        ...
        <View>
            <Text style = {{marginVertical: 20, textAlign: 'center', fontSize: 20}}>Mewlid programs</Text>
            <View style = {{alignItems: 'center'}}>
                <TouchableOpacity
                style = {styles.talktouch}
        ...
        <View>
            <Text style = {{marginVertical: 20, textAlign: 'center', fontSize: 20}}>stage works</Text>
            <View style = {{display: 'flex', flexDirection: 'row'}}>
                <TouchableOpacity
                style = {styles.talktouch}
        ...
        <View>
            <Text style = {{marginVertical: 20, textAlign: 'center', fontSize: 20}}>Event and holiday</Text>
            <View style = {{alignItems: 'center'}}>
                <TouchableOpacity
                style = {styles.talktouch}
