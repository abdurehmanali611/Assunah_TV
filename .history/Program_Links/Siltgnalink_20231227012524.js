...
const Siltgnalink = () => {
    ...
    return <View>
        <Text style = {{marginVertical: 20, textAlign: 'center', fontSize: 19}}>Siltgna Program schedule</Text>
        <View>
            <Text style = {{marginVertical: 20, textAlign: 'center', fontSize: 19}}>Education and Timely Education</Text>
