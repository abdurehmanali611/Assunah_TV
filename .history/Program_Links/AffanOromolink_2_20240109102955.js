...
const AffanOromolink_2 = ({navigation}) => {
    ...
    return <ScrollView showsVerticalScrollIndicator = {false}>
        ...
        <Text style = {styles.headerup}>Affan Oromo program schedule 2</Text>
            <View>
                <Text style = {styles.header}>Seasonal programs</Text>
            ...
            <View>
               <Text style = {styles.header}>Short Programs</Text>
               <View style = {styles.group2touch}>
               <View style = {{display: 'flex', flexDirection: 'row'}}>
                     <TouchableOpacity
                     style = {styles.seasontouch}
                     onPress={() => Linking.openURL('https://www.youtube.com/watch?v=VGeqENvGjP8&list=PLZaq281_mc43g147G5LIulC3-s9zHOeUc&pp=iAQB')}
                     >
                     ...
                     >
                        <Text>ABDULKARIIM</Text>
                     </TouchableOpacity>
                </View>
                </View>
            </View>
            <View>
               <Text style = {styles.header}>Talk show</Text>
               <View style = {styles.group2touch}>
               <View style = {{alignItems: 'center'}}>
                     <TouchableOpacity
                     style = {styles.seasontouch}
                     onPress={() => Linking.openURL('https://www.youtube.com/watch?v=KQaOekCX7uE&list=PLZaq281_mc40HwwDj1b_d7el3ZlxhGsHB&pp=iAQB')}
                     >
                        <Text>KEESSUMOOTA wallin</Text>
                     </TouchableOpacity>
                </View>
                </View>
            </View>
            <View>
                <Text style = {styles.header}>Women's Program</Text>
                <View style = {styles.group2touch}>
                <View style = {{alignItems: 'center'}}>
                     <TouchableOpacity
                     style = {styles.seasontouch}
            ...
            <View>
                <Text style = {styles.header}>Mewlid Program</Text>
                <View style = {styles.group2touch}>
                <View style = {{alignItems: 'center'}}>
                     <TouchableOpacity
                     style = {styles.seasontouch}
            ...
            <View>
                <Text style = {styles.header}>Event and holiday</Text>
                <View style = {styles.group2touch}>
                <View style = {{display: 'flex', flexDirection: 'row'}}>
                     <TouchableOpacity
                     style = {styles.seasontouch}
            ...
            <View>
                <Text style = {styles.header}>Quran and Praying</Text>
                <View style = {styles.group2touch}>
