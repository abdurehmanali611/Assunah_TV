...
const Amhariclink_5 = ({navigation}) => {
    ...
    return <ScrollView>
        <View>
            <Text style = {styles.}>Amharic Program Schedule 5</Text>
            <View>
                <Text style = {{fontSize: 20, marginVertical: 20, textAlign: 'center'}}>Quran and praying</Text>
            ...
            <View>
                <Text style = {{fontSize: 20, marginVertical: 20, textAlign: 'center'}}>Program slogan's</Text>
                <View style = {{alignItems: 'center'}}>
                    <TouchableOpacity
            ...
            <View>
                <Text style = {{fontSize: 20, marginVertical: 20, textAlign: 'center'}}>Health Program</Text>
                <View style = {{alignItems: 'center'}}>
                    <TouchableOpacity
            ...
            <View>
                <Text style = {{fontSize: 20, marginVertical: 20, textAlign: 'center'}}>Fetwa</Text>
                <View style = {{alignItems: 'center'}}>
                    <TouchableOpacity
            ...
            <View>
                <Text style = {{fontSize: 20, marginVertical: 20, textAlign: 'center'}}>Documentary</Text>
                <View style = {{display: 'flex', flexDirection: 'row'}}>
                    <TouchableOpacity
