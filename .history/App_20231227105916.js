  ...
  return (
    <NavigationContainer>
      <stack.Navigator initialRouteName="Log" >
         <stack.Screen name="Log" component={Login} options={{title: 'Assunah TV'}}/>
         <stack.Screen name="Sign" component={SignUp} options={{title: 'Assunah TV'}}/>
         ...
         <stack.Screen name="siltgna" component={Siltgna}/>
         ...
         <stack.Screen name="siltgnalink" component={Siltgnalink}/>
         <stack.Screen name="Halabalink" component={Halabalink}/>
         <stack.Screen name="Haderelink" component={Haderelink}/>
