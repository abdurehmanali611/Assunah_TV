...
const LoginQirat = ({navigation}) => {
    ...
    const nextPage = () => {
        ...
        if(name === ''|| name2 === '' || 
        name3 === ''|| name4 === '' || region === ''|| ischecked === false){
            Alert.alert(
                'Input',
    ...
    return <ScrollView>
       ...
       <View>
        ...
        <View style = {{marginVertical: 10}}>
            ...
            <TextInput 
            value= {name2}
            onChangeText={(newfname) => setName2(newfname)}
        ...
        <View style = {{marginVertical: 10}}>
            ...
            <TextInput 
            value={name3}
            onChangeText={(newgfname) => setName3(newgfname)}
            style = {{marginHorizontal: 50,backgroundColor: `rgb(50,100,100)`, width: 300, height: 45, borderRadius: 20, textAlign: 'center'}}
        ...
        <View style = {{marginVertical: 10}}>
            ...
            <TextInput 
            value={name4}
            onChangeText={(newgfname) => setName4(newgfname)}
            style = {{marginHorizontal: 50,backgroundColor: `rgb(50,100,100)`, width: 300, height: 45, borderRadius: 20, textAlign: 'center'}}
        ...
        <View style = {{marginVertical: 10}}>
            ...
            <TextInput 
            value={name5}
            onChangeText={(newgfname) => setName5(newgfname)}
            style = {{marginHorizontal: 50,backgroundColor: `rgb(50,100,100)`, width: 300, height: 45, borderRadius: 20, textAlign: 'center'}}
